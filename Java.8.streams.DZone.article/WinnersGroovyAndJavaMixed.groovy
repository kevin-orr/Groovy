...
/**
 * Just thought I'd demo combining the Java and Groovy examples from DZone article
 * @author kevinorr
 */
class WinnersGroovyAndJavaMixed {
    /**
     We'll keep the same Groovy constructs but use the Java streams too
     */
    int year
    String nationality
    String name
    ...
    static void main(String...args) {
        ...
        assert winnersOfToursLessThan3500km_groovy == winnersOfToursLessThan3500km, 'we have a diff between java and groovy...'
